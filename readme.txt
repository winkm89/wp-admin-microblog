...
Copyright 2010-2019 by Michael Winkler
...
= 3.1.1 - (05.11.2019) =
* New: Menu position is now editable via WPAM_MENU_POSITION constant 
* Bugfix: Compatibility checked with WordPress 5.2+
